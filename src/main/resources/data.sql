...
insert into transaction values(11002, 9.5, 10, 'CREDIT', 'Transaction 2 for Account 1', sysdate(), 10001);
insert into transaction values(11003, 4, 1, 'DEBIT', 'Transaction 3 for Account 1', sysdate(), 10001);
...
insert into transaction values(11006, 4.5, 111, 'DEBIT', 'Transaction 3 for Account 2', sysdate(), 10002);